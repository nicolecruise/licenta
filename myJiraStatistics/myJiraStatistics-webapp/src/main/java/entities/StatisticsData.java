...
//@NamedQuery(name = StatisticsData.GET_ALL_Data, query = "SELECT pet from StatisticsData pet WHERE data.type ='release'")
	...
	public void setValue(Integer value) { this.value = value; }
	 ...
	 @Override
	  public boolean equals(Object o) {
	    ...
	    boolean result = id.equals(data.id) && 
	    		issueType.equalsIgnoreCase(data.issueType) &&
	    		project.equalsIgnoreCase(data.project)&& 
	    		sprint.equals(data.sprint) && 
